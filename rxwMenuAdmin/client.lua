local ESX, IdSelected, modeAdmin, showCoords, showName, godMode, freezeP, noClipMod, staffMode, isNoClip, annonceState, cooldown, modeDelgun, delgun, NoClipSpeedMax, normalSpeed, gamerTags, ServersIdSession, playerResult, allReportClient = nil, nil, false, false, false, false, false, false, false, false, false, false, false, false, 2, 0.5, {}, {}, {}, {}
local carGestion = {
    DoorIndex = 1,
...
function menuAdmin()
    ...
    while menuP do
        ...
        RageUI.IsVisible(menuP, true, true, true, function()
            ...
            RageUI.Checkbox("Activer/Désactiver le Staff Mode",nil, modeAdmin,{},function(_, _, Selected, Checked)
                if Selected then
                    modeAdmin = Checked
                    if Checked then
            ...
            if staffMode then
                ...
                RageUI.ButtonWithStyle("Gestion Personel", nil, {RightLabel = "→→→"},true, function(_, _, _)
                end, menuS)

                RageUI.ButtonWithStyle("Gestion Serveur", nil, {RightLabel = "→→→"},true, function(_, _, _)
                end, menuGS)

                RageUI.ButtonWithStyle("Gestion Joueurs", nil, {RightLabel = "→→→"},true, function(_, _, _)
                end, menuJ)

                if IsPedSittingInAnyVehicle(PlayerPedId()) then
                    RageUI.ButtonWithStyle("Gestion Voitures", nil, {RightLabel = "→→→"},true, function(_, _, _)
                    end, menuVoi)
                else
                    RageUI.ButtonWithStyle("Gestion Voitures", nil, {RightLabel = "→→→"},false, function(_, _, _)
                    end)
                end

                RageUI.ButtonWithStyle("Gestion Report", nil, {RightLabel = "→→→"},true, function(_, _, Selected)
                    if Selected then
                ...
                RageUI.ButtonWithStyle("Gestion DelGun", nil, {RightLabel = "→→→"},true, function(_, _, _)
                end, menuDel)
        ...
        RageUI.IsVisible(menuS, true, true, true, function()
            ...
            RageUI.ButtonWithStyle("TP marker", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
            ...
            RageUI.Checkbox("Afficher les coordonnées",nil, showCoords,{},function(_, _, Selected, Checked)
                if Selected then
                    showCoords = Checked
                    if Checked then
            ...
            RageUI.Checkbox("Afficher id + nom",nil, showName,{},function(_, _, Selected, Checked)
                if Selected then
                    showName = Checked
                    if Checked then
            ...
            RageUI.Checkbox("NoClip",nil, noClipMod,{},function(_, _,Selected,Checked)
                if Selected then
                    noClipMod = Checked
                    if Checked then
                        ToggleNoClipMode()
            ...
            RageUI.Checkbox("Invincible",nil, godMode,{},function(_, _,Selected,Checked)
                if Selected then
                    godMode = Checked
                    if Checked then
            ...
            RageUI.ButtonWithStyle("Heal", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
            ...
            RageUI.ButtonWithStyle("Revive", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
            ...
            RageUI.ButtonWithStyle("Item", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
            ...
            if not Config.armesItems then
                RageUI.ButtonWithStyle("Armes", nil, {RightLabel = "→"},true, function(_, _, Selected)
                    if Selected then
            ...
            RageUI.ButtonWithStyle("Argent propre", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
                    local amountGive = rxwMenuAdminKeyboard("Combien ?", "", 20)
            ...
            RageUI.ButtonWithStyle("Argent banque", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
                    local amountGive = rxwMenuAdminKeyboard("Combien ?", "", 20)
                    if tonumber(amountGive) then
            ...
            RageUI.ButtonWithStyle("Argent sale", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
                    local amountGive = rxwMenuAdminKeyboard("Combien ?", "", 20)
                    if tonumber(amountGive) then
        ...
        RageUI.IsVisible(menuJ, true, true, true, function()
            ...
            for k, v in ipairs(ServersIdSession) do
                ...
                RageUI.ButtonWithStyle(v.." : " ..GetPlayerName(GetPlayerFromServerId(v)), nil, {RightLabel = "→→→"},true, function(_, _, Selected)
                    if Selected then
                        IdSelected = v
        ...
        RageUI.IsVisible(menuJO, true, true, true, function()
            ...
            RageUI.ButtonWithStyle("Se téléporter à lui", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
                    TriggerServerEvent("rxwMenuAdmin:gotoPlayer", IdSelected)
                end
            end)

            RageUI.ButtonWithStyle("Le téléporter sur moi", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
            ...
            RageUI.ButtonWithStyle("Informations", nil, {RightLabel = "→→→"},true, function(_, _, Selected)
                if Selected then
                    ESX.TriggerServerCallback('rxwMenuAdmin:getPlayerInfos', function(result)
                        playerResult = result
                    end, IdSelected)
            ...
            RageUI.ButtonWithStyle("setJob", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
            ...
            RageUI.ButtonWithStyle("setJob2", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
                    local jobName = rxwMenuAdminKeyboard("Nom du job ?", "", 20)
                    local gradeJob = rxwMenuAdminKeyboard("Grade ?", "", 20)
                    if jobName and tonumber(gradeJob) then
            ...
            RageUI.Checkbox("Freeze / Unfreeze",nil, freezeP,{},function(_, _,Selected,Checked)
                if Selected then
                    freezeP = Checked
                    if Checked then
            ...
            RageUI.ButtonWithStyle("Kick", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
            ...
            RageUI.ButtonWithStyle("Kill", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
                    TriggerServerEvent("rxwMenuAdmin:killPlayer", IdSelected)
                end
            end)

            RageUI.ButtonWithStyle("Wipe", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
                    TriggerServerEvent("rxwMenuAdmin:wipePlayer", IdSelected)
                end
            end)

            RageUI.ButtonWithStyle("Warn", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
        ...
        RageUI.IsVisible(menuJOI, true, true, true, function()
            ...
            for _, v in pairs(playerResult.inventory) do
                if v.count > 0 then
                    RageUI.ButtonWithStyle("→→ "..v.label, nil, {RightLabel = "x"..v.count},true, function(_, _, _)
                    end)
                end
            end
        ...
        RageUI.IsVisible(menuGS, true, true, true, function()
            ...
            RageUI.ButtonWithStyle("Annonce", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
            ...
            RageUI.ButtonWithStyle("Delete all peds", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
            ...
            RageUI.ButtonWithStyle("Soleil", "Vous permets de le soleil sur la ville", { RightLabel = "→→" }, not cooldown, function(_, _, Selected)
                if Selected then
            ...
            RageUI.ButtonWithStyle("Nuageux", "Vous permets des nuage", { RightLabel = "→→" }, not cooldown, function(_, _, Selected)
                if Selected then
            ...
            RageUI.ButtonWithStyle("Pluie", "Vous permets de la pluis", { RightLabel = "→→" }, not cooldown, function(_, _, Selected)
                if Selected then
            ...
            RageUI.ButtonWithStyle("Orage", "Vous permets de faire une tempête d'orage", { RightLabel = "→→" }, not cooldown, function(_, _, Selected)
                if Selected then
            ...
            RageUI.ButtonWithStyle("Neige", "Vous permets de faire une tempête de neige", { RightLabel = "→→" }, not cooldown, function(_, _, Selected)
                if Selected then
        ...
        RageUI.IsVisible(menuVoi, true, true, true, function()
            ...
            local Vengine_floor = math.floor(Vengine)
            ...
            RageUI.Separator("Etat du moteur~s~ =~b~ "..Vengine_floor.."%")

            RageUI.ButtonWithStyle("Allumer/Eteindre le Moteur", nil, {}, true, function(_, _, Selected)
                if (Selected) then
                    if IsPedSittingInAnyVehicle(PlayerPedId()) then
            ...
            RageUI.List("Ouvrir/Fermer Porte", carGestion.DoorList, carGestion.DoorIndex, nil, {}, true, function(_, _, Selected, Index)
                if (Selected) then
                    if IsPedSittingInAnyVehicle(PlayerPedId()) then
                        local plyVeh = GetVehiclePedIsIn(PlayerPedId(), false)
            ...
            RageUI.ButtonWithStyle("Ouvrir/Fermer Capot", nil, {}, true, function(_, _, Selected)
                if (Selected) then
                    if IsPedSittingInAnyVehicle(PlayerPedId()) then
                        local plyVeh = GetVehiclePedIsIn(PlayerPedId(), false)
            ...
            RageUI.ButtonWithStyle("Ouvrir/Fermer Coffre", nil, {}, true, function(_, _, Selected)
                if (Selected) then
                    if IsPedSittingInAnyVehicle(PlayerPedId()) then
                        local plyVeh = GetVehiclePedIsIn(PlayerPedId(), false)
            ...
            RageUI.ButtonWithStyle("Réparer le véhicule", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
                    if IsPedSittingInAnyVehicle(PlayerPedId()) then
                        local plyVeh = GetVehiclePedIsIn(PlayerPedId(), false)
            ...
            RageUI.ButtonWithStyle("Supprimer le véhicule", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
                    if IsPedSittingInAnyVehicle(PlayerPedId()) then
                        local plyVeh = GetVehiclePedIsIn(PlayerPedId(), false)
                        DeleteEntity(plyVeh)
            ...
            RageUI.ButtonWithStyle("Custom au maximum", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
                    if IsPedSittingInAnyVehicle(PlayerPedId()) then
                        FullVehicleBoost()
                    else
        ...
        RageUI.IsVisible(menuRep, true, true, true, function()
            ...
            if #allReportClient == 0 then
                ...
                for k, infoPlayer in pairs(allReportClient) do
                    RageUI.ButtonWithStyle("[~y~"..infoPlayer.idPlayer.."~s~] →→ "..infoPlayer.namePlayer, nil, {RightLabel = "→"},true, function(_, _, Selected)
                        if Selected then
        ...
        RageUI.IsVisible(menuRep2, true, true, true, function()
            ...
            RageUI.ButtonWithStyle("Cloturer ce report", nil, {RightLabel = "→"},true, function(_, _, Selected)
                if Selected then
        ...
        RageUI.IsVisible(menuDel, true, true, true, function()
            ...
            RageUI.Checkbox("Activer/Désactiver le Delgun",nil, modeDelgun,{},function(_, _,Selected,Checked)
